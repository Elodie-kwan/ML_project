...
```{r}
library(gridExtra)
p1 <- fviz_pca_biplot(Mountain_data.pca, axes = 1:2, col.var = "blue",col.ind = "red") 
p2 <- fviz_pca_biplot(Mountain_data.pca, axes = 3:4, col.var = "blue",col.ind = "red") 
p3 <- fviz_pca_biplot(Mountain_data.pca, axes = 5:6, col.var = "blue",col.ind = "red") 
