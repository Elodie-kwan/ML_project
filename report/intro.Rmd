...
in the referenced article, different analysis have been made on the facets of alpine plant diversity; functional (FD), phylogenetic (PD) and taxonomic diversity (TD), in the three different mountains and with contrasting evolutionary histories and climate conditions. It means that the used databese containes the plant species and the mountain characteristics
