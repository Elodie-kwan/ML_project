...
From these density graphs we agree on what has been seen before, that the *pH* is important. We can see that they have very different density for the three mountains so it can be a good feature to classify the mountains. 
